...
public:
    ...
    void batch_solve_mod(double sample_udf_threshold = 0.002, double corner_margin = 0.5, double edge_margin = 0.1, double plane_margin = 0.1, double singular_value_threshold = 0.01);
